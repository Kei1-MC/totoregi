...
// 「惣菜」への集約はやめ、売上日報の部門（天ぷら/魚/唐揚/冷惣菜/催事/イカ焼/エキタカ/
// くじら/コンビニデリカ/セルフ唐揚/セルフ天丼/セルフ惣菜/フライ/串揚/丼/個食/弁当/
// 弁当Ⅱ/生串揚/鯛）と1対1になるよう、表記ゆれのみを正規化する
// （商品の部門は hq_shohin_maint.php で日報と同じ部門名に登録し直す運用）
$category_map = [
    '焼魚'    => '魚',
    '煮魚'    => '魚',
    'いか焼き' => 'イカ焼',
